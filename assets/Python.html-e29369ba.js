...
<span class="token punctuation">}</span>
</code></pre></div><p>以上所有东西您都能改！我们写入了软件的启动命令<code>./plugin</code>。</p><p>回到HiperLink，查看并开启我们的插件。</p><p><img src="`+n+'" alt="HiperLink插件界面" title="HiperLink插件界面"></p>',31),c=[e];function u(l,k){return a(),p("div",null,c)}const d=s(o,[["render",u],["__file","Python.html.vue"]]);export{d as default};
